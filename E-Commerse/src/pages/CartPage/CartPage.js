...
import {NoItemFound} from "../../utils/images";
...
const CartPage = () => {
    ...
    const emptyCartMsg =<div className='text-center'><img src = {NoItemFound} alt = "NoItemFound" className='Noitemfound' />
    <h4><center>NoItemFound!!</center></h4>
    </div>
