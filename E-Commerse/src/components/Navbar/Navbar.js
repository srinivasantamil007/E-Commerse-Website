...
import {flipkart} from '../../utils/images';
  ...
  return (
    <nav className = "navbar">
      <div className='navbar-content'>
        <div className = "container">
          <div className = "navbar-top flex flex-between">
              <Link to = "/" className = "navbar-brand">
                <img src = {flipkart} alt = "logo" className="navbar-logo"/> 
                {/* <span className = "text-regal-blue">Scooby Doo</span>  */}
              </Link>
        ...
        <div className='navbar-bottom bg-color'>
